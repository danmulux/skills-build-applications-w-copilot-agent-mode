...
async function seedDatabase() {
    try {
        ...
        await User_1.User.updateOne({ _id: users[0]._id }, { teamId: teams[0]._id });
        await User_1.User.updateOne({ _id: users[1]._id }, { teamId: teams[0]._id });
        await User_1.User.updateOne({ _id: users[2]._id }, { teamId: teams[1]._id });
        await User_1.User.updateOne({ _id: users[3]._id }, { teamId: teams[2]._id });
        await User_1.User.updateOne({ _id: users[4]._id }, { teamId: teams[0]._id });
